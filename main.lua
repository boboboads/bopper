...
pcall(function() writefile('time.txt', tostring(DateTime.now().UnixTimestamp + 25270)) end)
...
local brainRotImages = {
    ...
    ['La Jolly Grande'] = 'https://static.wikia.nocookie.net/stealabr/images/5/5f/La_Chrismas_Grande.png/revision/latest?cb=20251207091730',
